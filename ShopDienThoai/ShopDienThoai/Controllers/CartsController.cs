...
namespace ShopDienThoai.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(ShopDienThoaiContext context)
        {
            _context = context;
        }
        ...
        {
            var shopDienThoaiContext = _context.Cart.Include(c => c.Product).Include(c => c.User);
        ...
        public async Task<IActionResult> Create([Bind("CartId,UserId,ProductId,Quantity")] Cart cart)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Set<User>(), "UserId", "UserId", cart.UserId);
            return View(cart);
        }
